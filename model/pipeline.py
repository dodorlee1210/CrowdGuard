...
if __name__ == "__main__":
  ...
  frames_dir = "/content/drive/MyDrive/data/sompt22/test/SOMPT22-03/img1/000001.jpg"
  frame = cv2.imread(frames_dir)

  model = CG_Pipeline(fps=30, corners=corner_points_arr, interval_speed_calculation=2)
  bird_eye_view_image, labeled_crowd_density, potential_for_crowd_crush = model.pipeline(frame, 1)
  print(f'potential_for_crowd_crush: {potential_for_crowd_crush}')
  plt.imshow(labeled_crowd_density)
  plt.imshow(bird_eye_view_image)
